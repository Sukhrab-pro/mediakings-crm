...
// {ИМЯ} → имя клиента, {ВРЕМЯ} → время консультации из лида, {ССЫЛКА} → ссылка на встречу
const MSG_TEMPLATES = [
  {
  ...
  {
    name: '\uD83D\uDCC5 Консультация Дарина',
    text: 'Привет! \uD83D\uDE0A Это Дарина из MediaKings. Напоминаю о нашей консультации — вот ссылка для подключения:\n{ССЫЛКА}\n\nЖду вас! \uD83C\uDFAC',
  },
  {
    name: '\uD83D\uDCC5 Консультация Сухраб',
    text: 'Привет! \uD83D\uDE0A Это Сухраб из MediaKings. Напоминаю о нашей консультации — вот ссылка для подключения:\n{ССЫЛКА}\n\nЖду вас! \uD83D\uDE80',
  },
  {
    name: '\uD83D\uDD14 Напоминание',
    text: '{ИМЯ}, добрый день!\uD83D\uDC4B Сегодня у нас с вами разбор Instagram\uD83D\uDCF8\nМогу звонить в {ВРЕМЯ}?',
  },
  {
    name: '\uD83D\uDC4B Приветствие Дарина',
    text: 'Привет! \uD83D\uDC4B Это Дарина из MediaKings. Увидела ваш запрос — мы помогаем бизнесам расти через Reels и TikTok. Когда удобно пообщаться? \uD83C\uDFAC',
  },
  {
    name: '\uD83D\uDC4B Приветствие Сухраб',
    text: 'Привет! \uD83D\uDC4B Это Сухраб из MediaKings. Вы интересовались продвижением через короткие видео — я готов рассказать как это работает. Когда можем созвониться? \uD83D\uDE80',
  },
];
