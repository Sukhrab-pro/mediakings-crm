...
// {ИМЯ} → имя клиента, {ВРЯМЯ} → время консультации из лида
const MSG_TEMPLATES = [
  {
    name: '\u{1F4AC} Подтверждение Сухраб',
    text: '{ИМЯ}, здравствуйте! Это Сухраб, продюсер рилс\u{1F4F8}, команда Дарины, приятно познакомиться\u{1F91D} Вы оставляли заявку у нас на разбор.\nМогу звонить сегодня в {ВРЕМЯ}?\u{1F60A}',
  },
  {
    name: '\u{1F465} Подтверждение Дарина',
    text: '{ИМЯ}, здравствуйте! Это Дарина, продюсер рилс, приятно познакомиться\u{1F91D} Вы оставляли заявку на разбор.\nМогу звонить сегодня в {ВРЕМЯ}?\u{1F60A}',
  },
];
